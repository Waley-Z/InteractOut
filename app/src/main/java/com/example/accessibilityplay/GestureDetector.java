...
public class GestureDetector {
    private static final int TOUCH_GESTURE_CLASSIFIED__CLASSIFICATION__SINGLE_TAP = 1;
    private static final int TOUCH_GESTURE_CLASSIFIED__CLASSIFICATION__LONG_PRESS = 2;
    private static final int TOUCH_GESTURE_CLASSIFIED__CLASSIFICATION__DEEP_PRESS = 3;
    private static final int TOUCH_GESTURE_CLASSIFIED__CLASSIFICATION__UNKNOWN_CLASSIFICATION = 4;
    ...
    private void init(@UiContext Context context) {
        ...
        if (context == null) {
            ...
            mAmbiguousGestureMultiplier = 2f;
        }
            ...
            case MotionEvent.ACTION_DOWN:
                if (mDoubleTapListener != null) {
                    ...
                    if ((mCurrentDownEvent != null) && (mPreviousUpEvent != null)
                        ...
                        // This is a first tap
                        mHandler.postDelayed(tapBegin, TAP_THRESHOLD);
